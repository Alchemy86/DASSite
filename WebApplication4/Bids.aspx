                ...
                <Columns>
                    ...
                    <EditItemTemplate>
                        <span class="pull-right">
                            <asp:LinkButton Text="Update" style="color: #ffffff; margin: 5px 0px 5px 20px" CssClass="btn btn-xs btn-primary" runat="server" CommandName="Update" CommandArgument='<%#Eval("AuctionID")%>'/>
                    ...
                    <asp:TemplateField HeaderText="" SortExpression="">
                        <ItemTemplate>
                            <span class="pull-right">
                            <asp:LinkButton id="lnkBtnDel" style="color: #ffffff; margin: 5px 0px 5px 20px" CssClass="btn btn-xs btn-danger" runat="server" CommandName="DeleteRow" OnClientClick="return confirm('Are you sure you want to Delete this Record?');" CommandArgument='<%#Eval("AuctionID")%>'>Delete</asp:LinkButton>
